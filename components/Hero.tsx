            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                ...
                <div className="lg:col-span-7 flex flex-col items-start space-y-8">
                    ...
                    <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl leading-relaxed border-l-2 border-zinc-200 dark:border-zinc-800 pl-6">
                        Focusing on <span className="text-zinc-900 dark:text-zinc-100 font-medium">Robotics</span>, <span className="text-zinc-900 dark:text-zinc-100 font-medium">Autonomous Systems</span>, <span className="text-zinc-900 dark:text-zinc-100 font-medium">Machine Learning</span>, <span className="text-zinc-900 dark:text-zinc-100 font-medium">Software Development</span>, and <span className="text-zinc-900 dark:text-zinc-100 font-medium">DevOps</span>.
